...
/*
You should also observe how your mini-shell works in comparison to a regular Linux shell.
Does it have all the same features? What limitations does it have? You should include your
observations as a comment in your code that is turned in.

This mini-shell has some of the basic features of a regular Linux shell. It can complete basic tasks and commands\
such as changing directories, setting new prompts, listing files, showing directory paths, showing the date, shwoing
machine statistics when running certain commands, and more. However, it cannot complete more complex tasks such as
piping.
